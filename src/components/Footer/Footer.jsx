                  ...
                  <div className="footer-mainC1A">
                    <div className="footer-mainC1A1">
                      <div className="footer-mainC1A1-logo">
                        <img
                          src="https://thebrandbee.com/assets/imgs/logo/footer-logo-white.webp"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="footer-mainC1A2">
                      <div className="footer-mainC1A2-para">
                        <p>
                        The Brand Bee is an integrated branding and
                        digital marketing agency based in
                        Gurgaon, India. With a team of over 40+, we
                        are an award-winning full-stack digital
                        marketing agency offering creative and
                        innovative digital and brand solutions for
                  ...
                  <div className="footer-mainC1B">
                    <div className="footer-mainC1B1">
                      <div className="footer-mainC1B1-info">
                        ...
                        <br />
                        <p>Brand Solutions</p>
                        <p>Digital Marketing <br/> Solutions</p>
                        <p>Who We Are</p>
                        <p>Sample Work</p>
                        <p>Our Clients</p>
                  ...
                  <div className="footer-mainC1C">
                    <div className="footer-mainC1C1">
                      <div className="footer-mainC1C1-contact">
                        ...
                        <br />
                        <p>
                        Brand Bee Management Pvt.
                        Ltd., V Block, Basement, GF &
                        2nd Floor, DLF Phase III, Gurgaon - 122002
                        </p>
                        <br />
                        <br />
                        <h2 className="mobile-no">+91-6205114811</h2>
                        <br />
                        <p>rohitsharma.sharma194@gmail.com</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="footer-mainC2A1">
                      <div className="footer-mainC2A1-G1">
                        ...
                        <div className="footer-mainC2A1-G-heading">
                          <h1>
                            {" "}
                            India's leading Digital Agency <span> |</span>{" "}
                          </h1>
                        </div>
                      </div>
