...
const CaseStudies = () => {
  return (
    <div className='casestudies-main1'>

        <div className='casestudies-main2'>
            ...
            <div className='casestudies-box1'>
                ...
                <div className='casestudies-video'>
                    <div className='casestudies-video1'>
                        <video autoPlay loop muted src='https://thebrandbee.com/assets/imgs/work/m-video.mp4' alt=''/>
                    </div>
                </div>
            </div>
            <br/>
            ...
            <div className='casestudies-box1'>
                <div className='casestudies-video'>
                    <div className='casestudies-video1'>
                        <video autoPlay loop muted src='https://thebrandbee.com/assets/imgs/work/Kumon-1000x696.mp4' alt=''/>
                    </div>
                </div>
                <div className='casestudies-heading'>
                    <div className='casestudies-title'>
...
<br/>Kumon Centres Branding</h4>
            ...
            <div className='casestudies-heading'>
                ...
                <div className='casestudies-video'>
                    <div className='casestudies-video1'>
                        <video autoPlay loop muted src='https://thebrandbee.com/assets/imgs/work/Lp-1000x756.mp4' alt=''/>
                    </div>
                </div>
            </div>
            <br/>
            ...
            <div className='casestudies-box1'>
                <div className='casestudies-video'>
                    <div className='casestudies-video1'>
                        <video autoPlay loop muted src='https://thebrandbee.com/assets/imgs/work/Urbanbed-1000x906.mp4' alt=''/>
                    </div>
                </div>
                <div className='casestudies-heading'>
                    <div className='casestudies-title'>
